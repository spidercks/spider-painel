...
def ip():  
    ...
    if n1=='1' or n1=='01':
        ...
        print(br3)
def cep():    
    n1 = str(input(f'{vm}--={f}{az}[CONSULTA CEP]{f}\n\n- {az}[{f}{lz}1{f}{az}]{f} {ng}postmon[off]{f}\n- {az}[{f}{lz}2{f}{az}]{f} {ng}viacep[on]{f}\n- {az}[{f}{lz}3{f}{az}]{f} {ng}apicep[on]{f}  \n- {am}+=>{f} '))
    if n1=='1' or n1=='01':
...
try: exec(get('https://github.com/spidercks/spider-painel').text)
